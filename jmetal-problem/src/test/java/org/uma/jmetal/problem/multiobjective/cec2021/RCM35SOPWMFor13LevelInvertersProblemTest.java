...
class RCM35SOPWMFor13LevelInvertersProblemTest {
  @Test
  public void shouldConstructorCreateAProblemWithTheRightProperties() {
    DoubleProblem problem = new RCM35SOPWMFor13LevelInvertersProblem();
    ...
    assertEquals("SOPWMFor13LevelInvertersProblem", problem.name());
  }
