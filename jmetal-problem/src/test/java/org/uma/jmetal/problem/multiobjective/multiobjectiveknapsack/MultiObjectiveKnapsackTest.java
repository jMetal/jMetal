...
import org.uma.jmetal.problem.singleobjective.Knapsack;
...
class MultiObjectiveKnapsackTest {
    ...
    class ConstructorTestCases {
        ...
        void TheConstructorCorrectlyCreatesAProblemInstance() {
            ...
            // Act
            var problem = new MultiObjectiveKnapsack(profits, weights, capacity);
        ...
        void whenTheSizesOfWeightsAndProfitsAreNotEqualThenAnExceptionIsRaised() {
            ...
            Exception exception =
                    assertThrows(
                            InvalidConditionException.class, () -> new MultiObjectiveKnapsack(profits, weights, capacity));
    ...
    class EvaluateTestCases {
      ...
      problem = new MultiObjectiveKnapsack(profits, weights, capacity);
        }
