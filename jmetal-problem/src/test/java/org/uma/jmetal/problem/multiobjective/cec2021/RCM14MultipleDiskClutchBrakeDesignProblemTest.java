...
class RCM14MultipleDiskClutchBrakeDesignProblemTest {
  @Test
  public void shouldConstructorCreateAProblemWithTheRightProperties() {
    DoubleProblem problem = new RCM14MultipleDiskClutchBrakeDesignProblem();
    ...
    assertEquals("MultipleDiskClutchBrakeDesignProblem", problem.name());
  }
