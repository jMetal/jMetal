...
class RCM26ProcessSynthesisAndDesignProblemTest {
  @Test
  public void shouldConstructorCreateAProblemWithTheRightProperties() {
    DoubleProblem problem = new RCM26ProcessSynthesisAndDesignProblem();
    ...
    assertEquals("ProcessSynthesisAndDesignProblem", problem.name());
  }
