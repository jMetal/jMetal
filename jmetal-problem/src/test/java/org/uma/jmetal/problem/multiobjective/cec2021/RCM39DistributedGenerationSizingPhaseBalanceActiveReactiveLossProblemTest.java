...
class RCM39DistributedGenerationSizingPhaseBalanceActiveReactiveLossProblemTest {
  @Test
  public void shouldConstructorCreateAProblemWithTheRightProperties() {
    DoubleProblem problem = new RCM39DistributedGenerationSizingPhaseBalanceActiveReactiveLossProblem();
    ...
    assertEquals("DistributedGenerationSizingPhaseBalanceActiveReactiveLossProblem", problem.name());
  }
