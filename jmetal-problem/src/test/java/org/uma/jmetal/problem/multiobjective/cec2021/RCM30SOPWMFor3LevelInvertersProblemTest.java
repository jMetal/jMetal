...
class RCM30SOPWMFor3LevelInvertersProblemTest {
  @Test
  public void shouldConstructorCreateAProblemWithTheRightProperties() {
    DoubleProblem problem = new RCM30SOPWMFor3LevelInvertersProblem();
    ...
    assertEquals("SOPWMFor3LevelInvertersProblem", problem.name());
  }
