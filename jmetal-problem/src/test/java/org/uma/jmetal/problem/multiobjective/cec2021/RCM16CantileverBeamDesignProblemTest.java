...
class RCM16CantileverBeamDesignProblemTest {
  @Test
  public void shouldConstructorCreateAProblemWithTheRightProperties() {
    DoubleProblem problem = new RCM16CantileverBeamDesignProblem();
    ...
    assertEquals("CantileverBeamDesignProblem", problem.name());
  }
