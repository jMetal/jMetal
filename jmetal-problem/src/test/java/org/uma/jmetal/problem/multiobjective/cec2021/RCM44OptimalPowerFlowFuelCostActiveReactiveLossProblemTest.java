...
class RCM44OptimalPowerFlowFuelCostActiveReactiveLossProblemTest {
  @Test
  public void shouldConstructorCreateAProblemWithTheRightProperties() {
    DoubleProblem problem = new RCM44OptimalPowerFlowFuelCostActiveReactiveLossProblem();
    ...
    assertEquals("OptimalPowerFlowFuelCostActiveReactiveLossProblem", problem.name());
  }
