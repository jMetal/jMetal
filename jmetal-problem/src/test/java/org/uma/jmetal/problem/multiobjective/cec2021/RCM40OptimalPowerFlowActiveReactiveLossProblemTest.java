...
class RCM40OptimalPowerFlowActiveReactiveLossProblemTest {
  @Test
  public void shouldConstructorCreateAProblemWithTheRightProperties() {
    DoubleProblem problem = new RCM40OptimalPowerFlowActiveReactiveLossProblem();
    ...
    assertEquals("OptimalPowerFlowActiveReactiveLossProblem", problem.name());
  }
