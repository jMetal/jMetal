...
class RCM23ReactorNetworkDesignProblemTest {
  @Test
  public void shouldConstructorCreateAProblemWithTheRightProperties() {
    DoubleProblem problem = new RCM23ReactorNetworkDesignProblem();
    ...
    assertEquals("ReactorNetworkDesignProblem", problem.name());
  }
  ...
  public void shouldEvaluateProduceFiniteValues() {
    ...
    assertEquals(5, solution.constraints().length);
  }
}
