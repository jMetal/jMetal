...
class RCM43OptimalPowerFlowFuelCostActiveLossProblemTest {
  @Test
  public void shouldConstructorCreateAProblemWithTheRightProperties() {
    DoubleProblem problem = new RCM43OptimalPowerFlowFuelCostActiveLossProblem();
    ...
    assertEquals("OptimalPowerFlowFuelCostActiveLossProblem", problem.name());
  }
