...
/**
 * Class representing the constrained function CF11: C-type constraint + r=1/2 + Concave PF + Sphere
 *
 ...
 */
public class CF11 extends AbstractDoubleProblem {
  ...
  /** Create a default CF11 problem (3 variables and 3 objectives) */
  public CF11() {
    this(3, 3); // 3 objectives and 3 decision variables
  }

  /**
   * Creates a CF11 problem instance
   *
   * @param numberOfVariables Number of variables
   * @param numberOfObjectives Number of objective functions
   */
  public CF11(Integer numberOfVariables, Integer numberOfObjectives) {
