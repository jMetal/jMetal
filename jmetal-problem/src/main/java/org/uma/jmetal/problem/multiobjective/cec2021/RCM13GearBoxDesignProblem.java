...
/**
 * Problem GearBoxDesignProblem (RCM13)
 *
 * Code adapted from:
 * CEC2021_func Real world Multi-objective Constrained Optimization Test Suite
 * Abhishek Kumar (email: abhishek.kumar.eee13@iitbhu.ac.in, Indian Institute of Technology (BHU), Varanasi)
 */
public class RCM13GearBoxDesignProblem extends AbstractDoubleProblem {

  public RCM13GearBoxDesignProblem() {
    numberOfObjectives(3);
    numberOfConstraints(11);
    name("GearBoxDesignProblem");
  ...
  public DoubleSolution evaluate(DoubleSolution solution) {
    ...
    double f3 = Math.sqrt(Math.pow(745 * x5 / (x2 * x3), 2) + 1.575e8) / (0.1 * Math.pow(x7, 3));
