 ...
 */
public class Ebes2 extends AbstractDoubleProblem implements ConstrainedProblem<DoubleSolution> {
  /**
   * Constructor.
...
//---- ANTONIO -----//
  ...
  public static final int CIRCLE = 0;         // section type, 1 variable (diÃ¡metro)
  public static final int HOLE_CIRCLE = 1;    // section type, 2 variable (diÃ¡metro externo y espesor)
  ...
  public void EBEsInitialize()  {
    ...
    try {
      ...
      Logger.getLogger(Ebes2.class.getName()).log(
