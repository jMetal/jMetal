package org.uma.jmetal.problem.novelty;
...
public class KursaweNovelty extends AbstractDoubleProblem {
  /**
   * Constructor.
   * Creates a default instance (3 variables) of the Kursawe problem
   */
  public KursaweNovelty() {
    this(3);
  }
   ...
   */
  public KursaweNovelty(Integer numberOfVariables) {
