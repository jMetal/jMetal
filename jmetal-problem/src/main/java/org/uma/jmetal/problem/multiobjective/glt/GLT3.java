...
public class GLT3 extends AbstractDoubleProblem {
  ...
  public void evaluate(DoubleSolution solution) {
    solution.objectives().set(0, (1.0 + g(solution))*solution.getVariable(0));
    if (solution.objectives().get(0) < 0.05) {
      solution.objectives().set(1, (1.0 + g(solution))*(1.0 - 19.0*solution.getVariable(0))) ;
    } else {
      solution.objectives().set(1, (1.0 + g(solution))*(1.0/19.0 - solution.getVariable(0)/19.0)) ;
    }
  }
