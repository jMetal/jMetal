...
public class ArrayReal extends Variable {
  ...
  public double getValue(int index) throws JMetalException {
    if ((index >= 0) && (index < size_)) {
      ...
      throw new JMetalException(
        org.uma.jmetal.encodings.variable.ArrayReal.class + ".ArrayReal: index value (" + index
          + ") invalid"
      );
    }
  }
  ...
  public void setValue(int index, double value) throws JMetalException {
    if ((index >= 0) && (index < size_)) {
      ...
      throw new JMetalException(
        org.uma.jmetal.encodings.variable.ArrayReal.class + ": index value (" + index + ") invalid");
    }
  }
  ...
  public double getLowerBound(int index) throws JMetalException {
    if ((index >= 0) && (index < size_)) {
      ...
      throw new JMetalException(
        org.uma.jmetal.encodings.variable.ArrayReal.class + ".getLowerBound: index value (" + index
          + ") invalid"
      );
    }
  }
  ...
  public double getUpperBound(int index) throws JMetalException {
    if ((index >= 0) && (index < size_)) {
      ...
      throw new JMetalException(
        org.uma.jmetal.encodings.variable.ArrayReal.class + ".getUpperBound: index value (" + index
          + ") invalid"
      );
    }
  }
