...
public class RWilcoxon {
  ...
  public static void generateScripts(
    ...
    for (int indicator = 0; indicator < experiment.indicatorList_.length; indicator++) {
      ...
      for (int i = 1; i < experiment.algorithmList_.length; i++) {
        latexTabularAlignment += "c";
        latexTableFirstLine += " & " + experiment.algorithmList_[i];
      } // for
      ...
      for (int i = 0; i < (experiment.algorithmList_.length - 1); i++) {
        algorithmList += "\"" + experiment.algorithmList_[i] + "\", ";
      }
      algorithmList += "\"" + experiment.algorithmList_[experiment.algorithmList_.length - 1] + "\") ";
      ...
      output = "# Step 2. Problem loop " + "\n" +
              ...
              "    if (i != \"" + experiment.algorithmList_[experiment.algorithmList_.length - 1]+ "\") {" + "\n" +
              ...
              "            write(\"  \", \"" + texFile + "\", append=TRUE)" + "\n" +
              "          }" + "\n" +
              "          if (j != \"" + experiment.algorithmList_[experiment.algorithmList_.length - 1] + "\") {" + "\n" +
              "            write(\" & \", \"" + texFile + "\", append=TRUE)" + "\n" +
              "          }" + "\n" +
              "          else {" + "\n" +
              "            write(\" \\\\\\\\ \", \"" + texFile + "\", append=TRUE)" + "\n" +
      ...
      for (int i = 1; i < experiment.algorithmList_.length; i++) {
        ...
        latexTableFirstLine += " & \\\\multicolumn{" + problems.length + "}{c|}{" + experiment.algorithmList_[i]+"}";
