...
public class jMetalExperiment extends Experiment {
  ...
  public void algorithmSettings(String problemName, 
    ...
    try {
      ...
      if (!paretoFrontFileList_[problemIndex].equals("")) {
        for (int i = 0; i < numberOfAlgorithms; i++)
  ...
  public static void main(String[] args) throws JMException, IOException {
    ...
    exp.algorithmList_ = new String[]{"SMPSOhv3","SMSEMOA","NSGA-II"};
    ...
    exp.paretoFrontFileList_ = new String[]{"ZDT1.pf", "ZDT2.pf","ZDT3.pf",
                                    "ZDT4.pf","ZDT6.pf",
