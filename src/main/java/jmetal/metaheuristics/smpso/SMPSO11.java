 ...
 */
public class SMPSO11 extends Algorithm {
   ...
   * @param problem Problem to solve
   */
  public SMPSO11(Problem problem, String trueParetoFront) throws FileNotFoundException {
    super(problem) ;
    hy_ = new Hypervolume();
    jmetal.qualityIndicator.util.MetricsUtil mu = new jmetal.qualityIndicator.util.MetricsUtil();
    trueFront_ = mu.readNonDominatedSolutionSet(trueParetoFront);
  ...
  public SolutionSet execute() throws JMException, ClassNotFoundException {
    ...
    while (iteration_ < maxIterations_) {
      try {
        ...
        Logger.getLogger(SMPSO11.class.getName()).log(Level.SEVERE, null, ex);
      }
