 ...
 */
public class SMPSOhv2 extends Algorithm {
   ...
   */
  public SMPSOhv2(Problem problem) {
    super(problem) ;
   ...
   * @param problem Problem to solve
   */
  public SMPSOhv2(Problem problem, String trueParetoFront) throws FileNotFoundException {
    super(problem) ;
    hy_ = new Hypervolume();
    jmetal.qualityIndicator.util.MetricsUtil mu = new jmetal.qualityIndicator.util.MetricsUtil();
    trueFront_ = mu.readNonDominatedSolutionSet(trueParetoFront);
  ...
  public SolutionSet execute() throws JMException, ClassNotFoundException {
    ...
    while (iteration_ < maxIterations_) {
      ...
      try {
        ...
        Logger.getLogger(SMPSOhv2.class.getName()).log(Level.SEVERE, null, ex);
      }
