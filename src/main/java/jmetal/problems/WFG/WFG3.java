...
public class WFG3 extends WFG{
   ...
   */
  public WFG3(String solutionType) throws ClassNotFoundException, JMException {
   ...
   * @param solutionType The solution type must "Real" or "BinaryReal".
   */
  public WFG3 (String solutionType, Integer k, Integer l, Integer M) throws ClassNotFoundException, JMException {
