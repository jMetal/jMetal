...
public class WFG2 extends WFG{
   ...
   */
  public WFG2(String solutionType) throws ClassNotFoundException, JMException {
   ...
   * @param solutionType The solution type must "Real" or "BinaryReal".
   */
  public WFG2(String solutionType, Integer k, Integer l, Integer M) throws ClassNotFoundException, JMException {
