...
public class F20_rotated_hybrid_composition_2_global_opt_bound extends TestFunc {
  ...
  static final public String DEFAULT_FILE_DATA = "" + Configuration.cec2005SupportDataDirectory +"/supportData/hybrid_func2_data.txt";
  static final public String DEFAULT_FILE_MX_PREFIX = "" + Configuration.cec2005SupportDataDirectory +"/supportData/hybrid_func2_M_D";
  ...
  // Constructors
  public F20_rotated_hybrid_composition_2_global_opt_bound (int dimension, double bias) throws JMException {
    this(dimension, bias, DEFAULT_FILE_DATA, DEFAULT_FILE_MX_PREFIX + dimension + DEFAULT_FILE_MX_SUFFIX);
  }
  public F20_rotated_hybrid_composition_2_global_opt_bound (int dimension, double bias, String file_data, String file_m) throws JMException {
