...
public class F18_rotated_hybrid_composition_2 extends TestFunc {
  ...
  // Constructors
  public F18_rotated_hybrid_composition_2 (int dimension, double bias) throws JMException {
    this(dimension, bias, DEFAULT_FILE_DATA, DEFAULT_FILE_MX_PREFIX + dimension + DEFAULT_FILE_MX_SUFFIX);
  }
  public F18_rotated_hybrid_composition_2 (int dimension, double bias, String file_data, String file_m) throws JMException {
