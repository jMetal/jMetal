...
public class F22_rotated_hybrid_composition_3_high_cond_num_matrix extends TestFunc {
  ...
  static final public String DEFAULT_FILE_DATA = "" + Configuration.cec2005SupportDataDirectory +"/supportData/hybrid_func3_data.txt";
  static final public String DEFAULT_FILE_MX_PREFIX = "" + Configuration.cec2005SupportDataDirectory +"/supportData/hybrid_func3_HM_D";
  ...
  // Constructors
  public F22_rotated_hybrid_composition_3_high_cond_num_matrix (int dimension, double bias) throws JMException {
    this(dimension, bias, DEFAULT_FILE_DATA, DEFAULT_FILE_MX_PREFIX + dimension + DEFAULT_FILE_MX_SUFFIX);
  }
  public F22_rotated_hybrid_composition_3_high_cond_num_matrix (int dimension, double bias, String file_data, String file_m) throws JMException {
