...
public class F25_rotated_hybrid_composition_4_bound extends TestFunc {
  ...
  static final public String DEFAULT_FILE_DATA = "" + Configuration.cec2005SupportDataDirectory +"/hybrid_func4_data.txt";
  static final public String DEFAULT_FILE_MX_PREFIX = "" + Configuration.cec2005SupportDataDirectory +"/hybrid_func4_M_D";
  ...
  public F25_rotated_hybrid_composition_4_bound (int dimension, double bias, String file_data, String file_m) throws JMException {
