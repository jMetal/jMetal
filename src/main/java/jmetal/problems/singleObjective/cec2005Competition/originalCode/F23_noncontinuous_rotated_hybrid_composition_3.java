...
public class F23_noncontinuous_rotated_hybrid_composition_3 extends TestFunc {
  ...
  // Constructors
  public F23_noncontinuous_rotated_hybrid_composition_3 (int dimension, double bias) throws JMException {
    this(dimension, bias, DEFAULT_FILE_DATA, DEFAULT_FILE_MX_PREFIX + dimension + DEFAULT_FILE_MX_SUFFIX);
  }
  public F23_noncontinuous_rotated_hybrid_composition_3 (int dimension, double bias, String file_data, String file_m) throws JMException {
