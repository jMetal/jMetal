...
public class F24_rotated_hybrid_composition_4 extends TestFunc {
  ...
  static final public String DEFAULT_FILE_DATA = "" + Configuration.cec2005SupportDataDirectory +"/supportData/hybrid_func4_data.txt";
  static final public String DEFAULT_FILE_MX_PREFIX = "" + Configuration.cec2005SupportDataDirectory +"/supportData/hybrid_func4_M_D";
  ...
  // Constructors
  public F24_rotated_hybrid_composition_4 (int dimension, double bias) throws JMException {
    this(dimension, bias, DEFAULT_FILE_DATA, DEFAULT_FILE_MX_PREFIX + dimension + DEFAULT_FILE_MX_SUFFIX);
  }
  public F24_rotated_hybrid_composition_4 (int dimension, double bias, String file_data, String file_m) throws JMException {
