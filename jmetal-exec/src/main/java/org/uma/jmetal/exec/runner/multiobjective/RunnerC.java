...
public class RunnerC {
   ...
   * Usage: three options
   *       - RunnerC propertiesFile
   *       - RunnerC propertiesFile problemName
   *       - RunnerC propertiesFile paretoFrontFile
  ...
  public static void main(String[] args) throws
    ...
    if (args.length == 0) {
      ...
      JMetalLogger.logger.log(Level.SEVERE, "a) RunnerC configurationFile ");
      JMetalLogger.logger.log(Level.SEVERE, "b) RunnerC configurationFile problemName");
      JMetalLogger.logger.log(Level.SEVERE, "c) RunnerC configurationFile problemName paretoFrontFile");
