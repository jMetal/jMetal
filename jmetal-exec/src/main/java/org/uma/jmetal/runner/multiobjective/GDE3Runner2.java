...
import org.uma.jmetal.algorithm.multiobjective.gde3.GDE3B;
...
public class GDE3Runner2 {
  ...
  public static void main(String[] args) {
    ...
    algorithm = new GDE3B.Builder(problem)
    ...
    List<DoubleSolution> population = ((GDE3B)algorithm).getResult() ;
