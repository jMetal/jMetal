...
public class RunnerC {
   ...
   * Usage: three options
   *       - org.uma.jmetal45.runner.multiobjective.RunnerC propertiesFile
   *       - org.uma.jmetal45.runner.multiobjective.RunnerC propertiesFile problemName
   *       - org.uma.jmetal45.runner.multiobjective.RunnerC propertiesFile paretoFrontFile
  ...
  public static void main(String[] args) throws
    ...
    if (args.length == 0) {
      ...
      JMetalLogger.logger.log(Level.SEVERE, "a) org.uma.jmetal45.runner.multiobjective.RunnerC configurationFile ");
      JMetalLogger.logger.log(Level.SEVERE, "b) org.uma.jmetal45.runner.multiobjective.RunnerC configurationFile problemName");
      JMetalLogger.logger.log(Level.SEVERE, "c) org.uma.jmetal45.runner.multiobjective.RunnerC configurationFile problemName paretoFrontFile");
