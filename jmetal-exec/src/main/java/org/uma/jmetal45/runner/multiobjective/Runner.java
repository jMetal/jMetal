...
public class Runner {
   ...
   * Usage: three options
   *       - org.uma.jmetal45.runner.multiobjective.Runner algorithmName
   *       - org.uma.jmetal45.runner.multiobjective.Runner algorithmName problemName
   *       - org.uma.jmetal45.runner.multiobjective.Runner problemName paretoFrontFile
  ...
  public static void main(String[] args) throws
    ...
    if (args.length == 0) {
      JMetalLogger.logger.log(Level.SEVERE, "Sintax error. Usage:\n" +
        "a) org.uma.jmetal45.runner.multiobjective.Runner algorithmName \n" +
        "b) org.uma.jmetal45.runner.multiobjective.RunnerC algorithmName problemName\n" +
        "c) org.uma.jmetal45.experiment.Main algorithmName problemName paretoFrontFile");
