...
public class WilconxonTestTable extends HtmlTable<WilconxonTestTable.Difference[]> {
    ...
    public WilconxonTestTable(Table table, String indicator, StringColumn algorithms, StringColumn problems, String indicatorValueColumnName) {
        this.title = "Test de Wilconxon";
