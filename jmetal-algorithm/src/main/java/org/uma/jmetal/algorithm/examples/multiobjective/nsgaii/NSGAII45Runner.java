...
public class NSGAII45Runner extends AbstractAlgorithmRunner {
  ...
  public static void main(String[] args) throws JMetalException, FileNotFoundException {
    ...
    var mutationDistributionIndex = 20.0 ;
      ...
      SelectionOperator<List<DoubleSolution>, DoubleSolution> selection = new BinaryTournamentSelection<>(new RankingAndCrowdingDistanceComparator<DoubleSolution>());

      Algorithm<List<DoubleSolution>> algorithm = new NSGAII45<>(problem, 25000, 100, crossover, mutation,
