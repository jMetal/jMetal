...
import org.uma.jmetal.qualityindicator.impl.hypervolume.HypervolumeContribution;
...
public class SMSEMOA2<S extends Solution<?>> extends AbstractGeneticAlgorithm<S, List<S>> {
  ...
  private HypervolumeContribution<S> hypervolumeContribution;
  ...
  public SMSEMOA2(
      ...
      Hypervolume hypervolumeImplementation) {
    super(problem);
  ...
  protected List<S> replacement(List<S> population, List<S> offspringPopulation) {
    ...
    hypervolumeContribution = new HypervolumeContribution<>(hypervolume);
    lastSubFront =
        hypervolumeContribution.computeHypervolumeContribution(lastSubFront, jointPopulation);
