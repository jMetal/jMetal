...
public class SurvivalScoreComparator<S extends Solution<?>> implements Comparator<S> {
    ...
    public int compare(@NotNull S solution1, S solution2) {
        ...
        var distance1 = (double) solution1.attributes().get(AGEMOEAEnvironmentalSelection.getAttributeId());
        var distance2 = (double) solution2.attributes().get(AGEMOEAEnvironmentalSelection.getAttributeId());
