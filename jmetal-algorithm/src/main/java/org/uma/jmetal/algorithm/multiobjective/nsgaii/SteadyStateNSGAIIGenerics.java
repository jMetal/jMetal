 ...
 */
public class SteadyStateNSGAIIGenerics<S extends Solution> extends NSGAIIGenerics<S> {
  /**
   * Constructor
   */
  public SteadyStateNSGAIIGenerics(Problem<S> problem, int maxIterations, int populationSize,
