 ...
 */
public class NSGAIIGenerics<S extends  Solution> extends AbstractGeneticAlgorithm<S, List<S>> {
   ...
   * Constructor
   */
  public NSGAIIGenerics(Problem problem, int maxIterations, int populationSize,
