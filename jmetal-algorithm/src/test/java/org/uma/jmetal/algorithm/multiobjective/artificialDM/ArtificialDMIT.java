package org.uma.jmetal.algorithm.multiobjective.artificialDM;
...
import org.uma.jmetal.util.artificialdecisionmaker.impl.ArtificialDM;
import org.uma.jmetal.util.artificialdecisionmaker.impl.ArtificialDMBuilder;
  ...
  public void shouldTheAlgorithmReturnANumberOfSolutionsWhenSolvingASimpleProblem() throws Exception {
    ...
    for (int cont = 0; cont < numberIterations; cont++) {
      ...
      AlgorithmRunner algorithmRunner = new AlgorithmRunner.Executor(algorithm)
          .execute();
      List<Double> referencePoints = ((ArtificialDM<DoubleSolution>) algorithm)
          .getReferencePoints();
    /*
