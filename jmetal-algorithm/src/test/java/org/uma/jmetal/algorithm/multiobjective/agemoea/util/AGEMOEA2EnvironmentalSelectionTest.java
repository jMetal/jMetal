...
public class AGEMOEA2EnvironmentalSelectionTest extends TestCase {
    ...
    public void testFindExtreme() {
        ...
        DefaultDoubleSolution s = new DefaultDoubleSolution(3,  new ArrayList<>());
        s.objectives()[0] = 1d/3d; s.objectives()[1] = 1d/3d; s.objectives()[2] = 1d/3d;
        front.add(s);
    ...
    public void testComputeSurvivalScore() {
        ...
        assertTrue(Double.isInfinite((Double) front.get(0).attributes().get(AGEMOEA2EnvironmentalSelection.getAttributeId())));
        assertTrue(Double.isInfinite((Double) front.get(1).attributes().get(AGEMOEA2EnvironmentalSelection.getAttributeId())));
        assertTrue(Double.isInfinite((Double) front.get(2).attributes().get(AGEMOEA2EnvironmentalSelection.getAttributeId())));
        assertEquals(2 + 2d/3d, (Double) front.get(3).attributes().get(AGEMOEA2EnvironmentalSelection.getAttributeId()));
    }
