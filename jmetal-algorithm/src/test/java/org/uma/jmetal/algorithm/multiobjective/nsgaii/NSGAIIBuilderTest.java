...
public class NSGAIIBuilderTest {
  ...
  public void testDefaultConfiguration() {
    ...
    assertEquals(1.0/NUMBER_OF_VARIABLES_OF_THE_MOCKED_PROBLEM, mutation.getMutationProbability(), EPSILON) ;
  ...
  @Test (expected = JMetalException.class)
  public void setNullCrossoverOperator() {
    builder.setCrossoverOperator(null) ;
  }

  @Test
  public void setNewMutationOperator() {
  ...
  @Test (expected = JMetalException.class)
  public void setNullMutationOperator() {
