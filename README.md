...
The Web page of the project is: [http://jmetal.github.io/jMetal/](http://jmetal.github.io/jMetal/). Former jMetal versions can be found in [SourceForge](http://jmetal.sourceforge.net). The current version is jMetal 5.2. The project documentation is available in this link: [https://github.com/jMetal/jMetalDocumentation](https://github.com/jMetal/jMetalDocumentation).
