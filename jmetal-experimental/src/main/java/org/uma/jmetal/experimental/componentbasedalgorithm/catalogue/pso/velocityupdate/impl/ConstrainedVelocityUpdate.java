...
public class ConstrainedVelocityUpdate implements VelocityUpdate {
  ...
  public double[][] update(List<DoubleSolution> swarm, double[][] speed, DoubleSolution[] localBest,
                           @NotNull BoundedArchive<DoubleSolution> leaders, @NotNull GlobalBestSelection globalBestSelection,
                           @NotNull InertiaWeightComputingStrategy inertiaWeightComputingStrategy) {
    double r1, r2, c1, c2;
