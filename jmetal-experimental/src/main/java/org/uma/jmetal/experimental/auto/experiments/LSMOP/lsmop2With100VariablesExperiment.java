...
import org.uma.jmetal.problem.multiobjective.lsmop.LSMOP2_2_100;
...
public class lsmop2With100VariablesExperiment {
    ...
    public static void main(String @NotNull [] args) throws IOException {
        ...
        problemList.add(new ExperimentProblem<>(new LSMOP2_2_100()).setReferenceFront("LSMOP1.2D.csv"));
        ...
        Experiment<DoubleSolution, List<DoubleSolution>> experiment =
                new ExperimentBuilder<DoubleSolution, List<DoubleSolution>>("LSMOP2With100VariablesAutoAlgorithmExperiments")
