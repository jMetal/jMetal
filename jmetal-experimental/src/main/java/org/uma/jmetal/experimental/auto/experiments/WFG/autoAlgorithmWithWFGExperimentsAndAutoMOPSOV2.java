 ...
 */
public class autoAlgorithmWithWFGExperimentsAndAutoMOPSOV2 {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Experiment<DoubleSolution, List<DoubleSolution>> experiment =
        new ExperimentBuilder<DoubleSolution, List<DoubleSolution>>("WFGAutoMOPSOv2Experiment")
  ...
  static List<ExperimentAlgorithm<DoubleSolution, List<DoubleSolution>>> configureAlgorithmList(
    ...
    for (int run = 0; run < INDEPENDENT_RUNS; run++) {
      ...
      for (ExperimentProblem<DoubleSolution> experimentProblem : problemList) {
        ...
        algorithms.add(new ExperimentAlgorithm<>(automopso, "AutoMOPSOv2", experimentProblem, run));
