 ...
 * instances of TSPLIB
 */
public class MOTSP extends Problem {
 ...
 /**
  * Creates a new MOTSP problem instance. It accepts data files from TSPLIB
  * @param filename The file containing the definition of the problem
  */
  public MOTSP(String solutionType, 
  		         String file_distances, 
  		         String file_cost) throws FileNotFoundException, IOException, ClassNotFoundException  {
...
//  cout << "I : " << i << ", x = " << x << ", y = " << y << endl ;    
  ...
  public double [][] readProblem(String file) throws FileNotFoundException,
                                                  IOException {
    double [][] matrix = null;
