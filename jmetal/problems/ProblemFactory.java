	...
	public Problem getProblem(String name, Object [] params) throws JMException {
		...
		if (name.substring(0,name.length()-1).equalsIgnoreCase("DTLZ"))
			...
			base += "ZDT.";    
				...
				(name.substring(0,name.length()-3).equalsIgnoreCase("ZZJ07")))
			base += "ZZJ07.";        
		else if ((name.length() > 3) && 
				(name.substring(0,name.length()-3).equalsIgnoreCase("LZ09")))
			base += "LZ09.";        
		else if ((name.length() > 4) && 
				(name.substring(0,name.length()-4).equalsIgnoreCase("ZZJ07")))
			base += "ZZJ07.";    
		else if ((name.length() > 3) && 
				(name.substring(0,name.length()-3).equalsIgnoreCase("LZ06")))
			base += "LZ06.";    
		else if ((name.length() > 4) && 
				(name.substring(0,name.length()-4).equalsIgnoreCase("CEC2009")))
			base += "cec2009Competition.";    
		else if ((name.length() > 5) && 
				(name.substring(0,name.length()-5)).equalsIgnoreCase("CEC2009"))
			base += "cec2009Competition.";    
