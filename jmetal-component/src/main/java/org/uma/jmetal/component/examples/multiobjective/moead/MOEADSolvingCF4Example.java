...
/**
 * Class to configure and run MOEA/D on the three-objective constrained problem CF4 (Xiang et al.,
 * "Constrained Multiobjective Optimization: Test Problem Construction and Performance Evaluations",
 * IEEE TEVC, 2021). Constraints are handled with the feasibility rules criterion, and every
 * evaluated solution is stored in an unbounded external archive; the result is a diverse subset of
 * the feasible non-dominated solutions found, selected by distance-based subset selection.
 *
 * @author Antonio J. Nebro
 */
public class MOEADSolvingCF4Example {

  public static void main(String[] args) throws JMetalException, IOException {
    Problem<DoubleSolution> problem = new CF4();
    String referenceParetoFront = "resources/referenceFrontsRSG/CF4.csv";
