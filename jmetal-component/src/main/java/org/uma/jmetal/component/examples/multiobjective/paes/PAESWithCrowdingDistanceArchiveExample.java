 ...
 * algorithm on a double-encoded problem. This example replaces the canonical adaptive grid with a
 * crowding-distance bounded archive ({@link CrowdingDistanceArchive}) as the density estimator.
 *
 * @author Antonio J. Nebro
 */
public class PAESWithCrowdingDistanceArchiveExample extends AbstractAlgorithmRunner {
