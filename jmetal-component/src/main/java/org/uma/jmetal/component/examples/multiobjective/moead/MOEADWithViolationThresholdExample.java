...
/**
 * Class to configure and run MOEA/D on the constrained problem Osyczka2, using the adaptive
 * violation threshold scheme of Jan and Khanum as subproblem update criterion.
 *
 * @author Antonio J. Nebro
 */
public class MOEADWithViolationThresholdExample {
