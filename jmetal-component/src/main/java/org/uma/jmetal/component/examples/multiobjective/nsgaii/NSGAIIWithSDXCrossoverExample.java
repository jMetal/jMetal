...
/**
 * Class to configure and run the NSGA-II algorithm using the {@link SDXCrossover} (Synthetic
 * Differences Crossover) operator.
 *
 ...
 */
public class NSGAIIWithSDXCrossoverExample {
  public static void main(String[] args) throws JMetalException, IOException {
    ...
    double f = 0.5;
    var crossover = new SDXCrossover(crossoverProbability, f);
