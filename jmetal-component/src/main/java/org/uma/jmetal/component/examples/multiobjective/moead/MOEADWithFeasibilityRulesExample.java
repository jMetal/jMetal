...
/**
 * Class to configure and run MOEA/D on the constrained problem Srinivas, using the feasibility
 * rules of the constrained dominance principle (Deb's rules) as subproblem update criterion.
 *
 * @author Antonio J. Nebro
 */
public class MOEADWithFeasibilityRulesExample {
