...
public class ArrayReal implements Variable {
  ...
  public double getValue(int index) throws JMetalException {
    if ((index >= 0) && (index < size)) {
      ...
      throw new JMetalException(
        org.uma.jmetal45.encoding.variable.ArrayReal.class + ".ArrayReal: index value (" + index
          + ") invalid"
      );
    }
  }
  ...
  public void setValue(int index, double value) throws JMetalException {
    if ((index >= 0) && (index < size)) {
      ...
      throw new JMetalException(
        org.uma.jmetal45.encoding.variable.ArrayReal.class + ": index value (" + index + ") invalid");
    }
  }
  ...
  public double getLowerBound(int index) throws JMetalException {
    if ((index >= 0) && (index < size)) {
      ...
      throw new JMetalException(
        org.uma.jmetal45.encoding.variable.ArrayReal.class + ".getLowerBound: index value (" + index
          + ") invalid"
      );
    }
  }
  ...
  public double getUpperBound(int index) throws JMetalException {
    if ((index >= 0) && (index < size)) {
      ...
      throw new JMetalException(
        org.uma.jmetal45.encoding.variable.ArrayReal.class + ".getUpperBound: index value (" + index
          + ") invalid"
      );
    }
  }
