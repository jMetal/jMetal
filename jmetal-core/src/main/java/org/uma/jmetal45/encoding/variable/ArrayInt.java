...
public class ArrayInt implements Variable {
  ...
  public int getValue(int index) throws JMetalException {
    if ((index >= 0) && (index < size)) {
      ...
      throw new JMetalException(
        org.uma.jmetal45.encoding.variable.ArrayInt.class + ": index value (" + index + ") invalid");
    }
  }
  ...
  public int getLowerBound(int index) throws JMetalException {
    if ((index >= 0) && (index < size)) {
      ...
      throw new JMetalException(
        org.uma.jmetal45.encoding.variable.ArrayInt.class + ".getLowerBound: index value (" + index
          + ") invalid"
      );
    }
  }
  ...
  public int getUpperBound(int index) throws JMetalException {
    if ((index >= 0) && (index < size)) {
      ...
      throw new JMetalException(
        org.uma.jmetal45.encoding.variable.ArrayInt.class + ".getUpperBound: index value (" + index
          + ") invalid"
      );
    }
  }
