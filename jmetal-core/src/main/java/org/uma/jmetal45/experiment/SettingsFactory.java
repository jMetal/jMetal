...
package org.uma.jmetal45.experiment;
...
public class SettingsFactory {
  ...
  public Settings getSettingsObject(String algorithmName, Object[] params)
    ...
    String base = "org.uma.jmetal45.experiment.settings." + algorithmName + "Settings";
    try {
      ...
      JMetalLogger.logger.log(Level.SEVERE, "SettingsFactory.getSettingsObject: " +
        ...
        "Please, check the algorithm name in org.uma.jmetal45/metaheuristic", e);
