 ...
 * $ java org.uma.jmetal45.qualityindicator.GeneralizedSpread <solutionFrontFile> <trueFrontFile> <getNumberOfObjectives>
...
public class GeneralizedSpread implements QualityIndicator {
  ...
  public double generalizedSpread(double [][] paretoFront, double [][] paretoTrueFront) {
    ...
    for (int i = 0; i < numberOfObjectives; i++) {
      Arrays.sort(normalizedParetoFront,new org.uma.jmetal45.qualityindicator.util.ValueComparator(i));
    ...
    Arrays.sort(normalizedFront, new org.uma.jmetal45.qualityindicator.util.LexicoGraphicalComparator());
