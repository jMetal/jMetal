...
/**
 * Defines an implementation of interface {@Link IntegerDoubleSolution}. This kind of solutions contains a two solutions:
 * an integer one and double one. The number of variables is then equal to two, having the first and second variable
 * assigned the integer and the double solution, respectively.
 *
...
public class DefaultIntegerDoubleSolution extends AbstractSolution<Solution<?>> implements IntegerDoubleSolution {
  ...
  public DefaultIntegerDoubleSolution(
    ...
    setVariable(0, new DefaultIntegerSolution(integerBounds, numberOfObjectives, numberOfConstraints));
    setVariable(1, new DefaultDoubleSolution(doubleBounds, numberOfObjectives, numberOfConstraints));
  }
