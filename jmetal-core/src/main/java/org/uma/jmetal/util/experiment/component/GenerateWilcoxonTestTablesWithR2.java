 ...
 */
public class GenerateWilcoxonTestTablesWithR2<Result> implements ExperimentComponent {
  private static final String DEFAULT_R_DIRECTORY = "R";

  private final Experiment<?, Result> configuration;

  public GenerateWilcoxonTestTablesWithR2(Experiment<?, Result> experimentConfiguration) {
