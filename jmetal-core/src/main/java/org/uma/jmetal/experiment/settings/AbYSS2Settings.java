...
public class AbYSS2Settings extends Settings {
...
private int numberOfSubranges ;
  ...
  /** Constructor */
  public AbYSS2Settings(String problem) throws JMetalException {
    super(problem);
  ...
  /** Configure AbYSS2 with default parameter settings */
  public Algorithm configure() throws JMetalException {
    ...
    algorithm = new AbYSS2.Builder(problem)
  ...
  /** Configure AbYSS2 from a properties file */
  @Override
