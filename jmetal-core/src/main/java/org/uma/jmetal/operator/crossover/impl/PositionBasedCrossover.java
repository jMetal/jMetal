 ...
 * This operator selects random positions to inherit genes from one parent.
 * The remaining genes are filled from the other parent in the order they appear, ensuring a valid permutation without duplicates.
