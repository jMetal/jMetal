...
public class GenericSinglePointCrossover<S extends BinarySolution> implements CrossoverOperator<S> {
     ...
     * Constructor
     */
    public GenericSinglePointCrossover(double crossoverProbability) {
        this(
     ...
     * Constructor
     */
  public GenericSinglePointCrossover(
          double crossoverProbability, @NotNull RandomGenerator<Double> randomGenerator) {
    this(
        crossoverProbability,
        randomGenerator,
  ...
  public List<S> doCrossover(
          double probability, @NotNull S parent1, @NotNull S parent2) {
