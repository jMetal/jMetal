...
public class DominanceComparatorTest {
  ...
  /**
   * Case A:
   * - solution1: [-1.0, 5.0, 9.0]
   * - solution2: [-1.0, 5.0, 8.99]
   * - epsilon: 0.01
   */
  @Test
  public void shouldCompareWorkProperlyWhenEpsilonIsGreaterThanZeroCaseA() {
    @SuppressWarnings("unchecked")
    ConstraintViolationComparator<Solution<?>> violationComparator = mock(ConstraintViolationComparator.class);
    ...
    when(solution2.getObjective(0)).thenReturn(-1.0);
    when(solution2.getObjective(1)).thenReturn(5.0);
    when(solution2.getObjective(2)).thenReturn(8.99);

    double epsilon = 0.01;
    comparator = new DominanceComparator<Solution<?>>(violationComparator, epsilon);
   ...
   * Case B:
   * - solution1: [-1.0, 5.0, 9.0]
   * - solution2: [-1.0, 5.0, 8.9]
   * - epsilon: 0.01
   */
  @Test
  public void shouldCompareWorkProperlyWhenEpsilonIsGreaterThanZeroCaseB() {
    @SuppressWarnings("unchecked")
    ConstraintViolationComparator<Solution<?>> violationComparator = mock(ConstraintViolationComparator.class);
    ...
    when(solution2.getObjective(0)).thenReturn(-1.0);
    when(solution2.getObjective(1)).thenReturn(5.0);
    when(solution2.getObjective(2)).thenReturn(8.9);
  ...
  /**
   * Case C:
   * - solution1: [-1.0, 5.0, 8.9]
   * - solution2: [-1.0, 5.0, 9.0]
   * - epsilon: 0.01
   */
  @Test
  public void shouldCompareWorkProperlyWhenEpsilonIsGreaterThanZeroCaseC() {
    @SuppressWarnings("unchecked")
    ConstraintViolationComparator<Solution<?>> violationComparator = mock(ConstraintViolationComparator.class);
    ...
    when(solution1.getObjective(0)).thenReturn(-1.0);
    when(solution1.getObjective(1)).thenReturn(5.0);
    when(solution1.getObjective(2)).thenReturn(8.9);
    when(solution2.getObjective(0)).thenReturn(-1.0);
    when(solution2.getObjective(1)).thenReturn(5.0);
    when(solution2.getObjective(2)).thenReturn(9.0);
