...
public class IdealPointTest {
  ...
  public void shouldUpdateWithTwoSolutionsLeadToTheCorrectIdealPoint() {
    ...
    assertEquals(0.0, referencePoint.getObjective(0), EPSILON) ;
    assertEquals(0.0, referencePoint.getObjective(1), EPSILON) ;
  }
  ...
  public void shouldUpdateWithThreeSolutionsLeadToTheCorrectIdealPoint() {
    ...
    assertEquals(0.2, referencePoint.getObjective(0), EPSILON) ;
    assertEquals(1.0, referencePoint.getObjective(1), EPSILON) ;
    assertEquals(1.5, referencePoint.getObjective(2), EPSILON) ;
  }}