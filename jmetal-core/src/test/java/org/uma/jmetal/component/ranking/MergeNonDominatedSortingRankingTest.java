  ...
  */
  ...
  public void shouldRankingWorkProperly() {
    ...
    */
    ...
    solution5.setObjective(2, 2);

    List<DoubleSolution> solutionList =
            Arrays.asList(solution1, solution2, solution4, solution3, solution5);

    Ranking<DoubleSolution> ranking = new MergeSortNonDominatedSortRanking<>(solutionList.size(), 3);
    ranking.computeRanking(solutionList);
  ...
  @Test
  public void shouldRankingOfAPopulationWorkWhenThereAreRepeatedSolutions() {
    DoubleProblem problem = new MockDoubleProblem(2,3);
    ...
    solution.setObjective(2, 4.0);
    DoubleSolution solution2 = problem.createSolution();
    solution2.setObjective(0, 2.0);
    solution2.setObjective(1, 3.0);
    solution2.setObjective(2, 4.0);
