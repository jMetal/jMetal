...
import org.uma.jmetal.auto.old.irace.parameter.crossover.CrossoverType;
import org.uma.jmetal.auto.old.irace.parameter.mutation.MutationType;
import org.uma.jmetal.auto.old.irace.parameter.repairstrategy.RepairStrategyType;
import org.uma.jmetal.auto.old.irace.parameter.selection.SelectionType;
...
public class AutoNSGAIIConfigurator {
  ...
  public EvolutionaryAlgorithm<DoubleSolution> configureAndGetAlgorithm() {
    ...
    if (algorithmResult.equals(AlgorithmResultType.externalArchive)) {
      archive = new CrowdingDistanceArchive<>(sizeOfTheFinalPopulation);
