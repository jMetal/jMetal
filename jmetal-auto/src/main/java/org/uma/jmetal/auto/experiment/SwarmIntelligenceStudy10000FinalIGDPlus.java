...
public class SwarmIntelligenceStudy10000FinalIGDPlus {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Experiment<DoubleSolution, List<DoubleSolution>> experiment =
        new ExperimentBuilder<DoubleSolution, List<DoubleSolution>>("SwarmIntelligenceExperiment10000FinalIGDPlus")
  ...
  private static void autoMOPSOZ(List<ExperimentAlgorithm<DoubleSolution, List<DoubleSolution>>> algorithms, int run, ExperimentProblem<DoubleSolution> experimentProblem) {
    String[] parameters =
        ("--problemName " + experimentProblem.getProblem().getClass().getName() + " "
            ...
            + "--velocityInitialization defaultVelocityInitialization "
            + "--perturbation frequencySelectionMutationBasedPerturbation "
            + "--mutationProbabilityFactor 0.7501 "
            + "--mutationRepairStrategy round "
            + "--inertiaWeightComputingStrategy constantValue "
            + "--velocityUpdate defaultVelocityUpdate "
            + "--c1Min 1.1001 "
            ...
            + "--velocityChangeWhenLowerLimitIsReached 0.9975 "
            + "--velocityChangeWhenUpperLimitIsReached -0.8072 "
            + "--uniformMutationPerturbation 0.8291 "
)
            .split("\\s+");
  ...
  private static void autoMOPSOD(List<ExperimentAlgorithm<DoubleSolution, List<DoubleSolution>>> algorithms, int run, ExperimentProblem<DoubleSolution> experimentProblem) {
    String[] parameters =
        ("--problemName " + experimentProblem.getProblem().getClass().getName() + " "
            ...
            + "--perturbation frequencySelectionMutationBasedPerturbation "
            + "--mutationProbabilityFactor 0.2753 "
            + "--mutationRepairStrategy round "
            ...
            + "--velocityChangeWhenLowerLimitIsReached 0.0257 "
            + "--velocityChangeWhenUpperLimitIsReached -0.0390 "
            + "--linkedPolynomialMutationDistributionIndex 202.3193 "
        )
            .split("\\s+");
  ...
  private static void autoMOPSOW(List<ExperimentAlgorithm<DoubleSolution, List<DoubleSolution>>> algorithms, int run, ExperimentProblem<DoubleSolution> experimentProblem) {
    String[] parameters =
        ("--problemName " + experimentProblem.getProblem().getClass().getName() + " "
            ...
            + "--perturbation frequencySelectionMutationBasedPerturbation "
            + "--mutationProbabilityFactor 0.1051 "
            ...
            + "--weightMax 0.5107 "
            + "--selectionTournamentSize 9 "
            + "--velocityChangeWhenLowerLimitIsReached -0.9922 "
            + "--velocityChangeWhenUpperLimitIsReached -0.7548 "
            + "--polynomialMutationDistributionIndex 385.0235 "
        )
            .split("\\s+");
  ...
  private static void autoMOPSORE(List<ExperimentAlgorithm<DoubleSolution, List<DoubleSolution>>> algorithms, int run, ExperimentProblem<DoubleSolution> experimentProblem) {
    String[] parameters =
        ("--problemName " + experimentProblem.getProblem().getClass().getName() + " "
            ...
            + "--velocityInitialization defaultVelocityInitialization "
            + "--perturbation frequencySelectionMutationBasedPerturbation "
            + "--mutationProbabilityFactor 1.6829 "
            + "--mutationRepairStrategy round "
            + "--inertiaWeightComputingStrategy constantValue "
            + "--velocityUpdate defaultVelocityUpdate "
            + "--c1Min 1.6524 "
            ...
            + "--frequencyOfApplicationOfMutationOperator 10 "
            + "--weight 0.1032 "
            + "--velocityChangeWhenLowerLimitIsReached 0.4656 "
            + "--velocityChangeWhenUpperLimitIsReached 0.8763 "
            + "--uniformMutationPerturbation 0.6202 "
        )
            .split("\\s+");
