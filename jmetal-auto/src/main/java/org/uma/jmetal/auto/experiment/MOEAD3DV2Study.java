...
import org.uma.jmetal.problem.multiobjective.dtlz.DTLZ3Minus;
import org.uma.jmetal.problem.multiobjective.dtlz.DTLZ4;
import org.uma.jmetal.problem.multiobjective.dtlz.DTLZ4Minus;
...
public class MOEAD3DV2Study {
  ...
  public static void main(String[] args) throws IOException {
    ...
    problemList.add(new ExperimentProblem<>(new DTLZ1Minus()));
    problemList.add(new ExperimentProblem<>(new DTLZ2Minus()));
    problemList.add(new ExperimentProblem<>(new DTLZ3Minus()));
    problemList.add(new ExperimentProblem<>(new DTLZ4Minus()));
    List<ExperimentAlgorithm<DoubleSolution, List<DoubleSolution>>> algorithmList =
        configureAlgorithmList(problemList);

    Experiment<DoubleSolution, List<DoubleSolution>> experiment =
        new ExperimentBuilder<DoubleSolution, List<DoubleSolution>>("moeadDTLZ3DExperimentV2")
            .setAlgorithmList(algorithmList)
            .setProblemList(problemList)
            .setReferenceFrontDirectory(experimentBaseDirectory + "/moeadDTLZ3DExperimentV2/referenceFronts")
