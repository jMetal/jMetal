 ...
 */
public class DefaultDoubleSolution2 implements DoubleSolution2 {
  ...
  public DefaultDoubleSolution2(List<Bounds<Double>> bounds, int numberOfObjectives, int numberOfConstraints) {
  ...
  public DefaultDoubleSolution2(DefaultDoubleSolution2 solution) {
  ...
  public Solution2 copy() {
    return new DefaultDoubleSolution2(this);
  }
}
