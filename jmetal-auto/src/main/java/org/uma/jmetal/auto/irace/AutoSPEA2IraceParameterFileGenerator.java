...
public class AutoSPEA2IraceParameterFileGenerator {
  ...
  public void generateConfigurationFile() {
    ...
    AutoSPEA2IraceParameterFileGenerator nsgaiiiraceParameterFile = new AutoSPEA2IraceParameterFileGenerator();
    nsgaiiiraceParameterFile.generateConfigurationFile(
        spea2WithParameters.autoConfigurableParameterList);
  }
  ...
  public static void main(String[] args) {
    new AutoSPEA2IraceParameterFileGenerator().generateConfigurationFile();
  }
}
