...
public class MutationParameter extends CategoricalParameter {
  ...
  public MutationOperator<DoubleSolution> getDoubleSolutionParameter() {
    ...
    double mutationProbability =
        (double) findGlobalParameter("mutationProbabilityFactor").value()
    ...
    switch (value()) {
      ...
      case "linkedPolynomial":
        ...
        break;
      case "uniform":
        Double perturbation = (Double) findSpecificParameter("uniformMutationPerturbation").value();
        result =
            new UniformMutation(
                mutationProbability, perturbation, repairDoubleSolution.getParameter());
        break;
      case "nonUniform":
  ...
  public MutationOperator<BinarySolution> getBinarySolutionParameter() {
    ...
    double mutationProbability =
        (double) findGlobalParameter("mutationProbabilityFactor").value() / numberOfBitsInASolution;
  ...
  public MutationOperator<PermutationSolution<Integer>> getPermutationParameter() {
    ...
    switch (value()) {
      case "swap":
        ...
        break;
      case "displacement":
        result = new DisplacementMutation<>(mutationProbability);
        break;
      case "insert":
        result = new InsertMutation<>(mutationProbability);
        break;
      case "scramble":
        result = new ScrambleMutation<>(mutationProbability);
        break;
      case "inversion":
