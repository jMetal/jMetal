...
.. code-block:: bash
  ...
  % java -cp jmetal-core/target/jmetal-core-6.11-SNAPSHOT-jar-with-dependencies.jar org.uma.jmetal.utilities.CommandLineQualityIndicatorTool
...
.. code-block:: bash
 ...
 % java -cp jmetal-core/target/jmetal-core-6.11-SNAPSHOT-jar-with-dependencies.jar org.uma.jmetal.utilities.CommandLineQualityIndicatorTool IGD resources/referenceFrontsCSV/ZDT1.csv FUN.csv
...
.. code-block:: bash
  ...
  % java -cp jmetal-core/target/jmetal-core-6.11-SNAPSHOT-jar-with-dependencies.jar org.uma.jmetal.utilities.CommandLineQualityIndicatorTool ALL resources/referenceFrontsCSV/ZDT1.csv FUN.csv
  ...
  INFO: AHD: 6.018706267698593E-3 [org.uma.jmetal.utilities.CommandLineQualityIndicatorTool calculateAndPrintIndicators]
  INFO: R2: 0.13257216418927098 [org.uma.jmetal.utilities.CommandLineQualityIndicatorTool calculateAndPrintIndicators]
