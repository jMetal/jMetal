...
Results comparison
------------------
Below is depicted the NSGA-II setting for three use case, default NSGA-II, the best configuration used in the GECCO paper and finally the best setting yielded by irace.

+----------------------------------------------------------+----------------------------------------+---------------------------------+---------------------------------+
| Parameter                                                | Default setting for NSGA-II            | GECCO setting for NSGA-II       | irace setting for NSGA-II       |
+==========================================================+========================================+=================================+=================================+
| *algorithmResult*                                        | population                             | externalArchive                 | externalArchive                 |
+----------------------------------------------------------+----------------------------------------+---------------------------------+---------------------------------+
| *populationSize*                                         | 100                                    | 200                             | 100                             |
+----------------------------------------------------------+----------------------------------------+---------------------------------+---------------------------------+
| *populationSizeWithArchive*                              | 100                                    | 20                              | 50                              |
+----------------------------------------------------------+----------------------------------------+---------------------------------+---------------------------------+
| *offspringPopulationSize*                                | 100                                    | 200                             | 100                             |
+----------------------------------------------------------+----------------------------------------+---------------------------------+---------------------------------+
| *createInitialSolutions*                                 | random                                 | latinHypercubeSampling          | latinHypercubeSampling          |
+----------------------------------------------------------+----------------------------------------+---------------------------------+---------------------------------+
| *variation*                                              | crossoverAndMutationVariation          | crossoverAndMutationVariation   | crossoverAndMutationVariation   |
+----------------------------------------------------------+----------------------------------------+---------------------------------+---------------------------------+
| *crossover*                                              | SBX                                    | BLX_Alpha                       | BLX_Alpha                       |
+----------------------------------------------------------+----------------------------------------+---------------------------------+---------------------------------+
| *crossoverProbability*                                   | 0.9                                    | 0.9874                          | 0.9662                          |
+----------------------------------------------------------+----------------------------------------+---------------------------------+---------------------------------+
| *crossoverRepairStrategy*                                | random                                 | bounds                          | bounds                          |
+----------------------------------------------------------+----------------------------------------+---------------------------------+---------------------------------+
| *sbxCrossoverDistributionIndex* *blxAlphaCrossoverAlpha* | 20.0                                   |  0.5906                         |  0.6395                         |
+----------------------------------------------------------+----------------------------------------+---------------------------------+---------------------------------+
| *mutation*                                               | polynomial                             | polynomial                      | polynomial                      |
+----------------------------------------------------------+----------------------------------------+---------------------------------+---------------------------------+
| *mutationProbability*                                    | 1/L                                    | 0.0015                          | 0.0058                          |
+----------------------------------------------------------+----------------------------------------+---------------------------------+---------------------------------+
| *mutationRepairStrategy*                                 | random                                 | random                          | round                           |
+----------------------------------------------------------+----------------------------------------+---------------------------------+---------------------------------+
| *polynomialMutationDistributionIndex*                    | 20.0                                   | 158.05                          | 8.6922                          |
+----------------------------------------------------------+----------------------------------------+---------------------------------+---------------------------------+
| *selection*                                              | tournament                             | tournament                      | tournament                      |
+----------------------------------------------------------+----------------------------------------+---------------------------------+---------------------------------+
| *selectionTournamentSize*                                | 2                                      | 9                               | 5                               |
+----------------------------------------------------------+----------------------------------------+---------------------------------+---------------------------------+

Quality Indicators
------------------
In this section is to compare the default, GECCO and auto-tuned NSGAII algorithms. For that purpose, we have made 25 independent runs of all of them to solve the WFG and DTLZ problems. After that, we have computed four quality indicators for measuring convergence (additive epsilon), diversity (spread), and both properties (hypervolume and IGD+). We report in the result tables the median and interquartile ranges, highlighting the best and second-best indicator values. All of them are described in the next links.

`Epsilon <../../resources/html/EP.html>`_

`Generational Distance <../../resources/html/GD.html>`_

`Hypervolume <../../resources/html/HV.html>`_

`Inverted Generational Distance Plus <../../resources/html/IGD+.html>`_

`Spread <../../resources/html/SPREAD.html>`_