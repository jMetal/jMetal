...
+-------------------------------------------+----------------------------------+-------------------+
| Default setting for NSGA-II               | GECCO setting for NSGA-II                                      |
+===========================================+==================================+==================+
| -algorithmResult population               | externalArchive                    |
+-------------------------------------------+-----------------------------------------------------+
| -populationSize 100                       | 20                                                 |
+-------------------------------------------+-----------------------------------------------------+
| -populationSizeWithArchive 100            | 20                                |
+-------------------------------------------+-----------------------------------------------------+
| -offspringPopulationSize 100              | 200                            |
+-------------------------------------------+-----------------------------------------------------+
| -createInitialSolutions random            | latinHypercubeSampling |
+-------------------------------------------+-----------------------------------------------------+
| -variation crossoverAndMutationVariation  | crossoverAndMutationVariation                     |
+-------------------------------------------+-----------------------------------------------------+
| -crossover SBX                            | BLX_Alpha                                  |
+-------------------------------------------+-----------------------------------------------------+
| -crossoverProbability 0.9                 | 0.9874                                         |
+-------------------------------------------+-----------------------------------------------------+
| -crossoverRepairStrategy random           | bounds                         |
+-------------------------------------------+-----------------------------------------------------+
| -sbxCrossoverDistributionIndex 20.0       | -blxAlphaCrossoverAlpha 0.5906                                       |
+-------------------------------------------+-----------------------------------------------------+
| -mutation polynomial                      | polynomial                             |
+-------------------------------------------+-----------------------------------------------------+
| -mutationProbability 1/L                  | 0.0015                                         |
+-------------------------------------------+-----------------------------------------------------+
| -mutationRepairStrategy random            | random                         |
+-------------------------------------------+-----------------------------------------------------+
| -polynomialMutationDistributionIndex 20.0 | 158.05                                        |
+---------------------------------------+-----------------------------------------------------+
| -selection tournament                     | tournament                              |
+-------------------------------------------+-----------------------------------------------------+
| -selectionTournamentSize 2                | 9                                             |
+---------------------------------------+-----------------------------------------------------+
