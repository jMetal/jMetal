...
Now, in the current release of jMetal (version 7.4), we propose a new architecture for the
...
Contrarily to the approach adopted in jMetal 5.0, in jMetal 7.4 the new architecture is not going
