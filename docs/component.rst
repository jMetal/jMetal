...
Now, in the current release of jMetal (version 7.3), we propose a new architecture for the
...
Contrarily to the approach adopted in jMetal 5.0, in jMetal 7.3 the new architecture is not going
