...
Now, in the current release of jMetal (version 7.2), we propose a new architecture for the
...
Contrarily to the approach adopted in jMetal 5.0, in jMetal 7.2 the new architecture is not going
